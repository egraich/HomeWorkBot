...
PLANNER_SYSTEM = (
    ...
    "или поменять план.»\n"
    "Пиши по-русски, живо и без воды. Формулы — юникодом Telegram (x², a¹ᐟ³, "
    "дроби через «/»), без LaTeX. Если материалы противоречат учебнику — скажи."
)
...
BRAIN_SYSTEM = (
    ...
    "- Формулы пиши юникодом Telegram: x², a¹ᐟ³, 2³, дроби через «/», √(), "
    "· для умножения. ЗАПРЕЩЕН LaTeX: никаких $...$, \\frac, ^{{}}, \\dfrac.\n"
    "- Если задание из учебника, опирайся на приложенные фрагменты страниц и "
    "изображения; не выдумывай номера упражнений.\n"
    "- Если в текущем сообщении нет номера упражнения, но он всплывал раньше "
    "в сессии — работай с последним упомянутым номером («проверь по ответам» "
    "после «1.42» значит проверить именно 1.42).\n"
